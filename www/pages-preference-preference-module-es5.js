...
var PreferencePage = /** @class */ (function () {
    function PreferencePage(auth, profileService) {
        this.auth = auth;
        this.profileService = profileService;
    }
    PreferencePage.prototype.ionViewWillEnter = function () {
        var _this = this;
        this.auth.isGuest()
            .then(function (isGuest_bl) {
            _this.is_guest_bl = isGuest_bl;
            if (isGuest_bl == true) {
                document.getElementById("username-title").innerHTML = "Hi, Guest!";
            }
            else {
                _this.profileService.getUserProfile()
    ...
    PreferencePage.ctorParameters = function () { return [
...
//# sourceMappingURL=pages-preference-preference-module-es5.js.map
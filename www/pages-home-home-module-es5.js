...
var HomePage = /** @class */ (function () {
    function HomePage(modalController, authService, productService) {
    ...
    HomePage.prototype.onSearchChange = function (e) {
        var _this = this;
        ...
        this.productService.searchProduct(value)
            ...
            _this.products = productsData;
        })
            .catch(function (error) {
            _this.products = {};
        });
    };
    HomePage.prototype.retrieveProducts = function () {
        var _this = this;
    ...
    HomePage.prototype.filterProduct = function () {
                    ...
                    case 1:
                        ...
                        modal.onDidDismiss()
                            ...
                            if (products_data.data.filteredProducts) {
                                _this.products = products_data.data.filteredProducts;
                            }
                        });

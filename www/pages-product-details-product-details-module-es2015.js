...
let ProductDetailsPage = class ProductDetailsPage {
    constructor(navCtrl, loadingController, activatedRoute, router, auth, productService, orderService) {
    ...
    purchase() {
        this.auth.isGuest()
            .then((userIsGuest_bl) => tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {

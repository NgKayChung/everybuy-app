...
let PaymentCompletePage = class PaymentCompletePage {
    constructor(navCtrl, activatedRoute, iab, orderService) {
    ...
    ionViewWillEnter() {
        this.activatedRoute.queryParams.subscribe(params => {
            ...
            this.orderService.getOrderDetails(this.orderID)
                .then((data) => {
                this.orderTime_st = (data["payment_time"] == null ? "-" : moment__WEBPACK_IMPORTED_MODULE_5__(new Date(data["payment_time"])).format("DD/MM/YYYY hh:mma"));
...
//# sourceMappingURL=pages-payment-complete-payment-complete-module-es2015.js.map